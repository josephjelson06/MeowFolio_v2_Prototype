...
export function StoryRail({ items, description, cta }: StoryRailProps) {
    ...
    <div>
      <div className="pub-section-head">
        <div>
          ...
          <div className="pub-section-desc">{description}</div>
        </div>
      ...
      <div className="pub-hscroll pub-story-rail" ref={railRef}>
        {items.map(item => (
          <article className="pub-story-card" key={item.step}>
