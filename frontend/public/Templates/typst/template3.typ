// ═══════════════════════════════════════════════════════════════════════════════
// MeowFolio — Template 3: Structured (DS_Template conversion)
// ═══════════════════════════════════════════════════════════════════════════════
...
#let highlight-color = rgb(
  opts.at("accentColorR", default: 34),
  opts.at("accentColorG", default: 120),
  opts.at("accentColorB", default: 75),
)
#let body-font = opts.at("fontFamily", default: "Lato")
