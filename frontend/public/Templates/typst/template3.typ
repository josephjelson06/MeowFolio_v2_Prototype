// ═══════════════════════════════════════════════════════════════════════════════
// MeowFolio — Template 3: Engineering Minimalist
// ═══════════════════════════════════════════════════════════════════════════════
// Reads resume data from a JSON string variable injected at compile time.
// Left-aligned, whitespace-heavy, clean tech-optimized layout.
// ═══════════════════════════════════════════════════════════════════════════════
...
#let body-font = typography.at("fontFamily", default: opts.at("fontFamily", default: "TeX Gyre Termes"))
...
#let section-gap-val = spacing.at("sectionGap", default: 12)
#let entry-gap-val = spacing.at("entryGap", default: 6)
...
#let entry-header(title, subtitle, location, date-str) = {
  block(breakable: false, {
    grid(
      ...
      text(size: body-size, date-str),
    )
    if location != "" {
      v(-0.2em)
      text(size: 9pt, style: "italic", fill: rgb(100, 100, 100), location)
      v(0.1em)
    }
  })
}
