// ═══════════════════════════════════════════════════════════════════════════════
// MeowFolio — Template 2: Sidebar (DS_Template conversion)
// ═══════════════════════════════════════════════════════════════════════════════
...
#let highlight-color = rgb(
  opts.at("accentColorR", default: 180),
  opts.at("accentColorG", default: 60),
  opts.at("accentColorB", default: 60),
)
#let body-font = typography.at("fontFamily", default: opts.at("fontFamily", default: "Roboto"))
...
#let section-heading(title) = {
  ...
  block(width: 100%, breakable: false, {
    ...
    text(fill: highlight-color, weight: "bold", font: heading-font, size: 12pt, upper(title))
